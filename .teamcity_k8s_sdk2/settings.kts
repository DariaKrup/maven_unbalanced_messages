...
project {
    ...
    buildType(BuildMavenUnbalancedMessagesTests)
    buildType(BuildMavenBookingAPITest)
    buildType(BuildSampleMaven)
    buildType(BuildAnt)
    ...
    features {
        ...
        kubernetesCloudImage {
            ...
            profileId = "kube-10"
            agentPoolId = "-2"
            agentNamePrefix = "teamcity-agent-linux-deployment-second"
            podSpecification = deploymentTemplate {
                deploymentName = "teamcity-agent-linux-deployment"
            }
        }
...
object BuildMavenBookingAPITest : BuildType({
...
object BuildMavenUnbalancedMessagesTests : BuildType({
...
object BuildSampleMaven : BuildType({
    name = "Build: Sample Maven"

    vcs {
        root(HttpsBitbucketOrgTeamcityTestSampleMavenAppRefsHeadsMaster)
    }
...
object HttpsBitbucketOrgTeamcityTestSampleMavenAppRefsHeadsMaster : GitVcsRoot({
